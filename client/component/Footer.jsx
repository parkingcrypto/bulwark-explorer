      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            <div>Copyright &copy; 2018 <a href="https://bulwarkcrypto.com/" target="_blank">Bulwark Cryptocurrency</a></div>
            <div>Copyright &copy; 2018 <a href="https://parkingcrypto.org/" target="_blank">Parking Cryptocurrency</a></div>
            <div>Site design / Logo &copy; 2018 <a href="https://parkingcrypto.org/" target="_blank">Parking Cryptocurrency</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              ...
              <a href="http://discord.gg/Pw642Tn" target="_blank">
                <Icon name="discord" className="fab footer__social-media-icon" />
              </a>
              <a href="https://t.me/parkingcrypto/" target="_blank">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/parkingcrypto/" target="_blank">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/parkingcrypto/" target="_blank">
                <Icon name="twitter" className="fab footer__social-media-icon" />
              </a>
              <a href="https://www.reddit.com/parkingcrypto/" target="_blank">
